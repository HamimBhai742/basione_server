...
<body>
 ...
 <p class="main-text">
 This is a confirmation that your <strong>Spandoek Print</strong> account password
 was successfully changed.
 </p>

 <div class="warning-box">
 Als u deze wijziging hebt gedaan, is er geen verdere actie nodig.
 Als u uw wachtwoord <strong>niet</strong> hebt gewijzigd, kan uw account risico lopen.
 </div>

 <p class="main-text">
 Beveilig in dat geval direct uw account:
 </p>
