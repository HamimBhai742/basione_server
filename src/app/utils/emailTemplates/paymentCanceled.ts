...
">
 ...
 ">Betaling geannuleerd</h1>

 <p style="
 margin: 0;
 color: rgba(255,255,255,0.82);
 font-size: 15px;
 ">Uw betaling en bestelling zijn succesvol geannuleerd.</p>
 </td>
 </tr>
 ...
 line-height: 1.7;
 ">
 We willen u laten weten dat uw betaling van
 <strong style="color:#4b5563;">EUR ${amount.toFixed(2)}</strong>
 aan <strong style="color:#1a3faa;">Spandoek Print</strong> is geannuleerd.
 Er zijn geen kosten in rekening gebracht op uw account.
 </p>
 ...
 <p style="margin: 0 0 4px; font-size: 13px; color: #6b7280; text-transform: uppercase; letter-spacing: 1px; font-weight: 600;">Geannuleerd bedrag</p>
 <p style="margin: 0 0 6px; font-size: 38px; font-weight: 800; color: #374151; letter-spacing: -1px; text-decoration: line-through; opacity: 0.6;">EUR ${amount.toFixed(2)}</p>
 <p style="margin: 0; font-size: 13px; color: #6b7280;">Er zijn geen kosten in rekening gebracht op uw account.</p>
 </td>
 </tr>
 </table>
 ...
 <p style="margin: 0 0 4px; font-size: 12px; font-weight: 700; color: #4b5563; text-transform: uppercase; letter-spacing: 0.8px;">Reden van annulering</p>
 ...
 letter-spacing: 1px;
 font-weight: 700;
 ">Gegevens van geannuleerde bestelling</p>
 ...
 padding: 6px 16px;
 ">
 <span style="font-size: 13px; color: #374151; font-weight: 700;"> Betaalstatus: geannuleerd</span>
 </td>
 </tr>
 </table>
 </td>
 ...
 <p style="margin: 0 0 4px; font-size: 12px; font-weight: 700; color: #15803d; text-transform: uppercase; letter-spacing: 0.8px;"> Restitutie-informatie</p>
 <p style="margin: 0; font-size: 13.5px; color: #166534; line-height: 1.6;">
 Als er een bedrag is afgeschreven, wordt het volledige bedrag binnen <strong>5-7 werkdagen</strong> via uw oorspronkelijke betaalmethode teruggestort, afhankelijk van uw bank.
 </p>
 </td>
 </tr>
 </table>
 ...
 text-align: center;
 ">
 Van gedachten veranderd? U bent altijd weer welkom. 
 </p>
 ...
 <strong>Heeft u vragen?</strong> Als u deze annulering niet hebt aangevraagd of verdere hulp nodig hebt,
 ...
 Deze e-mail is verzonden naar <strong>${email}</strong> over een annulering op uw Spandoek Print-account.<br/>
